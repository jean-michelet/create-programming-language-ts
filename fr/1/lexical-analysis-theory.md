...
Considérons le langage **L2** défini sur l'alphabet **Σ**, composé de l'ensemble des mots (composés d'au moins 1 caractère) qu'il est possible de créer, encadré par le symbole `%`.
